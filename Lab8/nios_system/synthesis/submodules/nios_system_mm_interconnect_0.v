...
module nios_system_mm_interconnect_0 (
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> otg_hpi_r_s1_agent:cp_valid
	wire  [106:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> otg_hpi_r_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // otg_hpi_r_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [12:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> otg_hpi_r_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> otg_hpi_r_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> otg_hpi_r_s1_agent:cp_endofpacket
	...
	wire  [106:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> otg_hpi_cs_s1_agent:cp_data
	...
	wire  [106:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> otg_hpi_reset_s1_agent:cp_data
	...
	wire  [106:0] cmd_mux_011_src_data;                                                               // cmd_mux_011:src_data -> otg_hpi_data_s1_agent:cp_data
	...
	wire          otg_hpi_r_s1_agent_rp_valid;                                                        // otg_hpi_r_s1_agent:rp_valid -> router_008:sink_valid
	wire  [106:0] otg_hpi_r_s1_agent_rp_data;                                                         // otg_hpi_r_s1_agent:rp_data -> router_008:sink_data
	wire          otg_hpi_r_s1_agent_rp_ready;                                                        // router_008:sink_ready -> otg_hpi_r_s1_agent:rp_ready
	wire          otg_hpi_r_s1_agent_rp_startofpacket;                                                // otg_hpi_r_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          otg_hpi_r_s1_agent_rp_endofpacket;                                                  // otg_hpi_r_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [106:0] otg_hpi_cs_s1_agent_rp_data;                                                        // otg_hpi_cs_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [106:0] otg_hpi_reset_s1_agent_rp_data;                                                     // otg_hpi_reset_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [106:0] otg_hpi_data_s1_agent_rp_data;                                                      // otg_hpi_data_s1_agent:rp_data -> router_013:sink_data
	...
	wire          otg_hpi_r_s1_agent_rdata_fifo_src_valid;                                            // otg_hpi_r_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] otg_hpi_r_s1_agent_rdata_fifo_src_data;                                             // otg_hpi_r_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          otg_hpi_r_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_006:in_0_ready -> otg_hpi_r_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> otg_hpi_r_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> otg_hpi_r_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // otg_hpi_r_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> otg_hpi_r_s1_agent:rdata_fifo_sink_error
