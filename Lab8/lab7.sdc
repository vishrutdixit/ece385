...
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {VGA_R}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {VGA_R}]

set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {VGA_G}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {VGA_G}]

set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {VGA_B}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {VGA_B}]

set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {VGA_CLK}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {VGA_CLK}]

set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {VGA_SYNC_N}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {VGA_SYNC_N}]

set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {VGA_BLANK_N}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {VGA_BLANK_N}]

set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {VGA_VS}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {VGA_VS}]

set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {VGA_HS}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {VGA_HS}]

set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {OTG_ADDR}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {OTG_ADDR}]

set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {OTG_CS_N}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {OTG_CS_N}]

set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {OTG_RD_N}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {OTG_RD_N}]

set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {OTG_WR_N}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {OTG_WR_N}]

set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {OTG_RST_N}]
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {OTG_RST_N}]
