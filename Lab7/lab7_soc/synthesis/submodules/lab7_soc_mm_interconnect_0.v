...
module lab7_soc_mm_interconnect_0 (
	...
	wire    [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> key_2_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> key_3_s1_agent:cp_channel
	...
	wire  [107:0] sw_s1_agent_rf_source_data;                                                         // SW_s1_agent:rf_source_data -> SW_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] sw_s1_agent_rsp_fifo_out_data;                                                      // SW_s1_agent_rsp_fifo:out_data -> SW_s1_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> SW_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // SW_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> SW_s1_agent:cp_channel
	...
	wire  [106:0] sw_s1_agent_rp_data;                                                                // SW_s1_agent:rp_data -> router_010:sink_data
	...
	wire    [8:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> crosser_001:in_channel
	...
	wire          sw_s1_agent_rdata_fifo_src_valid;                                                   // SW_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] sw_s1_agent_rdata_fifo_src_data;                                                    // SW_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          sw_s1_agent_rdata_fifo_src_ready;                                                   // avalon_st_adapter_008:in_0_ready -> SW_s1_agent:rdata_fifo_src_ready
	...
	lab7_soc_mm_interconnect_0_router_006 router_006 (
	...
	lab7_soc_mm_interconnect_0_router_006 router_008 (
	...
	lab7_soc_mm_interconnect_0_router_006 router_009 (
	...
	lab7_soc_mm_interconnect_0_router_006 router_010 (
	...
	lab7_soc_mm_interconnect_0_cmd_mux_004 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux_004 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux_004 cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux_004 cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_004 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_004 rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_004 rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
