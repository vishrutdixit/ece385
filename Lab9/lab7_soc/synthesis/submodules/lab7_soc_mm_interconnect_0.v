...
module lab7_soc_mm_interconnect_0 (
		...
		input  wire        sdram_pll_c1_clk,                                    //                                  sdram_pll_c1.clk
		input  wire        AES_RESET_reset_bridge_in_reset_reset,               //               AES_RESET_reset_bridge_in_reset.reset
	...
	wire  [104:0] cmd_demux_src6_data;                                                                // cmd_demux:src6_data -> crosser_001:in_data
	wire          cmd_demux_src6_ready;                                                               // crosser_001:in_ready -> cmd_demux:src6_ready
	wire    [7:0] cmd_demux_src6_channel;                                                             // cmd_demux:src6_channel -> crosser_001:in_channel
	...
	wire  [104:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_006:sink0_data
	wire          crosser_001_out_ready;                                                              // cmd_mux_006:sink0_ready -> crosser_001:out_ready
	wire    [7:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_006:sink0_channel
	...
	wire  [104:0] cmd_demux_001_src3_data;                                                            // cmd_demux_001:src3_data -> crosser_002:in_data
	wire          cmd_demux_001_src3_ready;                                                           // crosser_002:in_ready -> cmd_demux_001:src3_ready
	wire    [7:0] cmd_demux_001_src3_channel;                                                         // cmd_demux_001:src3_channel -> crosser_002:in_channel
	...
	wire  [104:0] crosser_002_out_data;                                                               // crosser_002:out_data -> cmd_mux_005:sink1_data
	wire          crosser_002_out_ready;                                                              // cmd_mux_005:sink1_ready -> crosser_002:out_ready
	wire    [7:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> cmd_mux_005:sink1_channel
	...
	wire          cmd_demux_001_src4_valid;                                                           // cmd_demux_001:src4_valid -> crosser_003:in_valid
	wire  [104:0] cmd_demux_001_src4_data;                                                            // cmd_demux_001:src4_data -> crosser_003:in_data
	wire          cmd_demux_001_src4_ready;                                                           // crosser_003:in_ready -> cmd_demux_001:src4_ready
	wire    [7:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> crosser_003:in_channel
	wire          cmd_demux_001_src4_startofpacket;                                                   // cmd_demux_001:src4_startofpacket -> crosser_003:in_startofpacket
	wire          cmd_demux_001_src4_endofpacket;                                                     // cmd_demux_001:src4_endofpacket -> crosser_003:in_endofpacket
	wire          crosser_003_out_valid;                                                              // crosser_003:out_valid -> cmd_mux_006:sink1_valid
	wire  [104:0] crosser_003_out_data;                                                               // crosser_003:out_data -> cmd_mux_006:sink1_data
	wire          crosser_003_out_ready;                                                              // cmd_mux_006:sink1_ready -> crosser_003:out_ready
	wire    [7:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> cmd_mux_006:sink1_channel
	...
	wire  [104:0] rsp_demux_005_src0_data;                                                            // rsp_demux_005:src0_data -> crosser_004:in_data
	wire          rsp_demux_005_src0_ready;                                                           // crosser_004:in_ready -> rsp_demux_005:src0_ready
	wire    [7:0] rsp_demux_005_src0_channel;                                                         // rsp_demux_005:src0_channel -> crosser_004:in_channel
	...
	wire  [104:0] crosser_004_out_data;                                                               // crosser_004:out_data -> rsp_mux:sink5_data
	wire          crosser_004_out_ready;                                                              // rsp_mux:sink5_ready -> crosser_004:out_ready
	wire    [7:0] crosser_004_out_channel;                                                            // crosser_004:out_channel -> rsp_mux:sink5_channel
	...
	wire  [104:0] rsp_demux_005_src1_data;                                                            // rsp_demux_005:src1_data -> crosser_005:in_data
	wire          rsp_demux_005_src1_ready;                                                           // crosser_005:in_ready -> rsp_demux_005:src1_ready
	wire    [7:0] rsp_demux_005_src1_channel;                                                         // rsp_demux_005:src1_channel -> crosser_005:in_channel
	...
	wire  [104:0] crosser_005_out_data;                                                               // crosser_005:out_data -> rsp_mux_001:sink3_data
	wire          crosser_005_out_ready;                                                              // rsp_mux_001:sink3_ready -> crosser_005:out_ready
	wire    [7:0] crosser_005_out_channel;                                                            // crosser_005:out_channel -> rsp_mux_001:sink3_channel
	...
	wire  [104:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> crosser_007:in_data
	wire          rsp_demux_006_src1_ready;                                                           // crosser_007:in_ready -> rsp_demux_006:src1_ready
	wire    [7:0] rsp_demux_006_src1_channel;                                                         // rsp_demux_006:src1_channel -> crosser_007:in_channel
	...
	wire          crosser_007_out_valid;                                                              // crosser_007:out_valid -> rsp_mux_001:sink4_valid
	wire  [104:0] crosser_007_out_data;                                                               // crosser_007:out_data -> rsp_mux_001:sink4_data
	wire          crosser_007_out_ready;                                                              // rsp_mux_001:sink4_ready -> crosser_007:out_ready
	wire    [7:0] crosser_007_out_channel;                                                            // crosser_007:out_channel -> rsp_mux_001:sink4_channel
	wire          crosser_007_out_startofpacket;                                                      // crosser_007:out_startofpacket -> rsp_mux_001:sink4_startofpacket
	wire          crosser_007_out_endofpacket;                                                        // crosser_007:out_endofpacket -> rsp_mux_001:sink4_endofpacket
	...
	wire          onchip_memory2_0_s1_agent_rdata_fifo_out_valid;                                     // onchip_memory2_0_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] onchip_memory2_0_s1_agent_rdata_fifo_out_data;                                      // onchip_memory2_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          onchip_memory2_0_s1_agent_rdata_fifo_out_ready;                                     // avalon_st_adapter_005:in_0_ready -> onchip_memory2_0_s1_agent_rdata_fifo:out_ready
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                         //                      clk.clk
		.reset                  (AES_RESET_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (AES_RESET_reset_bridge_in_reset_reset),          //       clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_router_004 router_008 (
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_clk           (sdram_pll_c1_clk),                                    //       out_clk.clk
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_clk            (sdram_pll_c1_clk),                                    //        in_clk.clk
	...
	lab7_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (AES_RESET_reset_bridge_in_reset_reset),    // in_rst_0.reset
	...
	lab7_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (sdram_pll_c1_clk),                                    // in_clk_0.clk
